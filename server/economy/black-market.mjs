...
export const MARKET_ITEMS = {
  ...
  crop_carrot: { id: 'crop_carrot', name: 'Carrot Crate', basePrice: 304, category: 'crop', icon: '🥕' },
  crop_potato: { id: 'crop_potato', name: 'Potato Sack', basePrice: 912, category: 'crop', icon: '🥔' },
  crop_beans: { id: 'crop_beans', name: 'Bean Bundle', basePrice: 2280, category: 'crop', icon: '🫘' },
  crop_corn: { id: 'crop_corn', name: 'Corn Bushel', basePrice: 6080, category: 'crop', icon: '🌽' },
  crop_cabbage: { id: 'crop_cabbage', name: 'Cabbage Head', basePrice: 15200, category: 'crop', icon: '🥬' },
