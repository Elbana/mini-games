...
export const MARKET_ITEMS = {
  ...
  crop_carrot: { id: 'crop_carrot', name: 'Carrot Crate', basePrice: 14, category: 'crop', icon: '🥕' },
  crop_potato: { id: 'crop_potato', name: 'Potato Sack', basePrice: 16, category: 'crop', icon: '🥔' },
  crop_beans: { id: 'crop_beans', name: 'Bean Bundle', basePrice: 19, category: 'crop', icon: '🫘' },
  crop_corn: { id: 'crop_corn', name: 'Corn Bushel', basePrice: 22, category: 'crop', icon: '🌽' },
  crop_cabbage: { id: 'crop_cabbage', name: 'Cabbage Head', basePrice: 26, category: 'crop', icon: '🥬' },
  crop_berry: { id: 'crop_berry', name: 'Berry Basket', basePrice: 32, category: 'crop', icon: '🫐' },
  crop_pumpkin: { id: 'crop_pumpkin', name: 'Pumpkin', basePrice: 38, category: 'crop', icon: '🎃' },
  crop_mushroom: { id: 'crop_mushroom', name: 'Mushroom Pack', basePrice: 45, category: 'crop', icon: '🍄' },
